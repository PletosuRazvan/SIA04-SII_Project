...
public class DepartamentsListView {
	...
	public List<DepartamentView> getDepartaments() { return departaments; }
	public void setDepartaments(List<DepartamentView> departaments) { this.departaments = departaments; }
}
